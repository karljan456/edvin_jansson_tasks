...
<div class="slider-wrapper">
    ...
    <div id="carousel" class="carousel slide wd-100">
        <div class="carousel-indicators">
            <button type="button" data-bs-target="#carousel" data-bs-slide-to="0" class="active" aria-current="false"
        ...
        <div class="carousel-inner">
            <a href="#">
                <div class="carousel-item active">
                    <img src="../tasks\images\carousel1.jpg" class="d-block w-100" alt="Mo Salah picture">
            ...
            <a href="#">
                <div class="carousel-item">
                    <img src="../tasks\images\virgil.jpg" class="d-block w-100" alt="Virgil image">
                    <div class="carousel-caption  d-md-block">
            ...
            <a href="#">
                <div class="carousel-item">
                    <img src="../tasks\images\ali.jpg" class="d-block w-100" alt="Alisson Becker image">
                    <div class="carousel-caption d-md-block">
        ...
        <article>
            <div class="container text-center text-dark article-container px-4  justify-content-center">
                <div class="row">
                    <div class="article-grid latest-box col-lg-4 col-md-12 justify-content-center">
                        <a href="#"><img class="img-fluid" src="../tasks\images\andy_robertson.png"
                    ...
                    <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                        <a href="#"><img class="img-fluid" src="../tasks\images\FA_youth_cup.png" alt="FA CUP picture">
                            <h4>
                    ...
                    <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                        <a href="#"><img class="img-fluid" src="../tasks\images\matt_beard.png"
            ...
            <div class="container article-grid-2nd text-center text-dark article-container2 px-4 ">
                <div class="row">
                    <div class=" article-grid latest-box col-lg-4 col-md-12">
                        <a href="#"><img class="img-fluid" src="../tasks\images\vandijk.png" alt="Virgil smiling">
                            <h4>
                    ...
                    <div class="  article-grid latest-box col-lg-4 col-md-12">
                        <a href="#"><img class="img-fluid" src="../tasks\images\shankly.png"
                    ...
                    <div class=" article-grid latest-box col-lg-4 col-md-12">
                        <a href="#"><img class="img-fluid" src="../tasks\images\xabi.png" alt="Picture of Xabi Alonso">
                            <h4>
            ...
            <div class="container">
                <div class="row neverforget">
                    <div class="col-md-6">
                        <img class="img-fluid" src="../tasks\images\neverforget.png" alt="neverforget">
                    </div>
                    <div class="col-md-6">
                        <img class="img-fluid" src="../tasks\images\inmemoria.png" alt="inmemoria">
                    </div>
                </div>
            </div>
        </article>
