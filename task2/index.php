                ...
                <div class="carousel-inner">
                    <a href="#">
                        <div class="carousel-item active">
                            <img src="carousel1.jpg" class="d-block w-100" alt="Mo Salah picture">
                    ...
                    <a href="#">
                        <div class="carousel-item">
                            <img src="virgil.jpg" class="d-block w-100" alt="Virgil image">
                            <div class="carousel-caption  d-md-block">
                    ...
                    <a href="#">
                        <div class="carousel-item">
                            <img src="ali.jpg" class="d-block w-100" alt="Alisson Becker image">
                            <div class="carousel-caption d-md-block">
                ...
                <article>
                    <div class="container text-center text-dark article-container px-4  justify-content-center">
                        <div class="row">
                            <div class="article-grid latest-box col-lg-4 col-md-12 justify-content-center">
                                <a href="#"><img class="img-fluid" src="andy_robertson.png"
                            ...
                            <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                                <a href="#"><img class="img-fluid" src="FA_youth_cup.png"
                                        alt="FA CUP picture">
                                    <h4>
                            ...
                            <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                                <a href="#"><img class="img-fluid" src="matt_beard.png"
                    ...
                    <div class="container article-grid-2nd text-center text-dark article-container2 px-4 ">
                        <div class="row">
                            <div class=" article-grid latest-box col-lg-4 col-md-12">
                                <a href="#"><img class="img-fluid" src="vandijk.png"
                                        alt="Virgil smiling">
                                    <h4>
                            ...
                            <div class="  article-grid latest-box col-lg-4 col-md-12">
                                <a href="#"><img class="img-fluid" src="shankly.png"
                            ...
                            <div class=" article-grid latest-box col-lg-4 col-md-12">
                                <a href="#"><img class="img-fluid" src="xabi.png"
                    ...
                    <div class="container">
                        <div class="row neverforget">
                            <div class="col-md-6">
                                <img class="img-fluid" src="neverforget.png" alt="neverforget">
                            </div>
                            <div class="col-md-6">
                                <img class="img-fluid" src="inmemoria.png" alt="inmemoria">
                            </div>
                        </div>
                    </div>
                </article>
